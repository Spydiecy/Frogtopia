  ...
  return (
    <div className="bg-gradient-to-b from-green-400 to-green-600 min-h-screen text-white">
      ...
      >
        ...
        <animated.button onClick={() => navigate('/home')} className="bg-yellow-300 hover:bg-yellow-400 text-green-700 font-bold py-3 px-8 rounded-full text-lg transition duration-300 transform hover:scale-105"
        >
          Explore Now
        </animated.button>
      </animated.section>
